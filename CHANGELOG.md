...
- Bump `com.openai/openai-java` (and `openai-java-bedrock`) to 4.69.2.

## [0.33.3] - 2026-09-24

### Changed

- Bump `com.openai/openai-java` (and `openai-java-bedrock`) to 4.69.1.
...
- Bump `com.openai/openai-java` (and `openai-java-bedrock`) to 4.68.0.
...
- Bump `com.openai/openai-java` (and `openai-java-bedrock`) to 4.63.2.
  No API surface changed upstream - this release is internal test
  hardening and a CI action bump only; full suite verified green with no
...
- Bump `com.openai/openai-java` and the optional Bedrock transport to 4.58.0.
